...
public class OperatorCommands {
    ...
    public static Command manualAmpTrap() {
        return new RunCommand(
                        () -> Robot.ampTrap.runPercentage(operator.controller.getLeftY()),
                        Robot.ampTrap)
    ...
    public static Command manualClimber() {
        return new RunCommand(
                        () -> Robot.climber.runPercentage(operator.controller.getLeftY()),
                        Robot.climber)
    ...
    public static Command manualElevator() {
        return new RunCommand(
                        () -> Robot.elevator.runPercentage(operator.controller.getLeftY()),
                        Robot.elevator)
    ...
    public static Command manualFeeder() {
        return new RunCommand(
                        () -> Robot.feeder.runPercentage(operator.controller.getLeftY()),
                        Robot.feeder)
    ...
    public static Command manualIntake() {
        return new RunCommand(
                        () -> Robot.intake.runPercentage(operator.controller.getLeftY()),
                        Robot.intake)
    ...
    public static Command manualPivot() {
        return new RunCommand(
                        () -> Robot.pivot.runManualOutput(operator.controller.getLeftY()),
                        Robot.pivot)
