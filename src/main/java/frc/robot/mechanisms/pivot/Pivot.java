...
public class Pivot extends Mechanism {
    public class PivotConfig extends Config {
        ...
        public final int autoLaunchPreload = 15;
        public final int autoLaunch2 = 17; // works for GP2/GP3/GP5/GP6 in Front 5 and GP2/GP4/5 in Front 5 Alt
        public final int autoLaunch3 = 23; // works for GP4 in Front 5 and GP3 in Front 5 Alt
