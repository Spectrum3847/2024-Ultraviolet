...
public class PilotCommands {
    ...
    public static Command manualAmpTrap() {
        return new RunCommand(() -> Robot.ampTrap.runPercentage(pilot.controller.getRightY()), Robot.ampTrap).withName("AmpTrap.manualOutput");
    }

    public static Command manualClimber() {
        return new RunCommand(() -> Robot.climber.runPercentage(pilot.controller.getRightY()), Robot.climber).withName("Climber.manualOutput");
    }

    public static Command manualElevator() {
        return new RunCommand(() -> Robot.elevator.runPercentage(pilot.controller.getRightY()), Robot.elevator).withName("Elevator.manualOutput");
    }

    public static Command manualFeeder() {
        return new RunCommand(() -> Robot.feeder.runPercentage(pilot.controller.getRightY()), Robot.feeder).withName("Feeder.manualOutput");
    }

    public static Command manualIntake() {
        return new RunCommand(() -> Robot.intake.runPercentage(pilot.controller.getRightY()), Robot.intake).withName("Intake.manualOutput");
    }

    public static Command manualPivot() {
        return new RunCommand(() -> Robot.pivot.runManualOutput(pilot.controller.getRightY()), Robot.pivot).withName("Pivot.manualOutput");
    }
