...
public class RotationController {
    ...
    public RotationController(Swerve swerve) {
        ...
        holdController = new PIDController(10.5, 3, 0); //TODO: these probably have to be found again; most likely why robot rotation is slightly oscillating in heading lock
